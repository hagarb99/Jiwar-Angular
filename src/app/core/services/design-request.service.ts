...
import { DesignRequest, CreateDesignRequest } from '../interfaces/design-request.interface';
...
export class DesignRequestService extends ApiBaseService {
    ...
    createDesignRequest(data: CreateDesignRequest): Observable<DesignRequest> {
